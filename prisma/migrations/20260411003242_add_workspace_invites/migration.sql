...
-- AlterTable
ALTER TABLE "CopyItem" ADD COLUMN     "workspaceId" TEXT;
...
-- CreateIndex
CREATE INDEX "WorkspaceInvite_inviteeEmail_idx" ON "WorkspaceInvite"("inviteeEmail");

-- CreateIndex
CREATE INDEX "CopyItem_workspaceId_idx" ON "CopyItem"("workspaceId");
...
-- AddForeignKey
ALTER TABLE "CopyItem" ADD CONSTRAINT "CopyItem_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace"("id") ON DELETE CASCADE ON UPDATE CASCADE;
